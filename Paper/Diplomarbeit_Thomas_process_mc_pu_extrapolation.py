...
# easy ...
conf["InputFiles"] = "/afs/naf.desy.de/user/p/piparo/lustre/DiplomArbeitThomas/ZPJ2011_DY_pu/dy_fall10_*.root" 
conf["OutputPath"] = LocalConfigBase.GetLocalOutputPath() + "extrapolation_dy_pu"
...
conf = JsonConfigBase.ExpandDefaultMcConfig( [0,30,60,100,140,500], conf, True )
