...
# easy ...
conf["InputFiles"] = "/afs/naf.desy.de/user/p/piparo/lustre/Paper/ZPJ2011_DY_pu_matched/dy_fall10_*pu_*_*out.root" 
conf["OutputPath"] = LocalConfigBase.GetLocalOutputPath() + "extrapolation_dy_pu_03_lite"
...
conf = JsonConfigBase.ExpandDefaultMcConfig(  [0, 6, 10, 16, 26, 38, 50, 72, 100, 250,1000],conf, True )
