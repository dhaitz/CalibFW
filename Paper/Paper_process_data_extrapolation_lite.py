...
conf["Algos"] = ["ak5PFJetsL1L2L3Res"]


# easy ...
conf["InputFiles"] = "/afs/naf.desy.de/user/p/piparo/lustre/Paper/ZPJ2011_data_nov4_corrected_newcoll/*root" 
conf["OutputPath"] = LocalConfigBase.GetLocalOutputPath() + "extrapolation_data_lite"

#conf = JsonConfigBase.ExpandDefaultDataConfig( [0,15,30,60,100,500], conf, True )
conf = JsonConfigBase.ExpandDefaultDataConfig(  [0, 6, 10, 16, 26, 38, 50, 72, 100, 250, 1000],conf, True )

#myown = copy.deepcopy( conf["Pipelines"]["default"] )
#myown["Filter"].append("ptbin")
#myown["FilterPtBinLow"] = 50.0
#myown["FilterPtBinHigh"] = 500.0
#myown["RootFileFolder"] = "Pt50to500_incut"

#conf["Pipelines"][ "Pt50to500_incut" ] = myown

#second_leading_jetpt = JsonConfigBase.ExpandRange( conf["Pipelines"], "CutSecondLeadingToZPt", [0.03, 0.05, 0.1, 0.13, 0.15, .17, 0.2, 0.3], True, True  )
