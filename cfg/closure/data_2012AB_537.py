...
conf["InputFiles"] = cbase.CreateFileList("/storage/8/dhaitz/Winter13ReReco_2/kappa_2012A*.root", sys.argv)
conf["InputFiles"] += cbase.CreateFileList("/storage/8/dhaitz/Winter13ReReco_2/kappa_2012B*.root", sys.argv)
