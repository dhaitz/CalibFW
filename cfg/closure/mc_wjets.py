...
conf["InputFiles"] = cbase.CreateFileList("/storage/6/berger/zpj/kappa534_MC12_background/kappa_WJets_madgraph*.root", sys.argv)
conf["OutputPath"] = "closure_bkgWJets_534"
