...
conf['Jec'] = cbase.GetBasePath() + "data/jec_data/Fall12_V4_DATA"
conf["InputFiles"] = cbase.CreateFileList("/storage/6/berger/zpj/kappa53_Data12/*.root", sys.argv)
conf["OutputPath"] = "closure_data_2012_Fall12JEC_V4"
...
cbase.AddCorrectionPlots(conf, base_algorithms, l3residual = True, forIncut=True, forAllevents=True, forIncutVariations=True, forAlleventsVariations=False)
...
cbase.AddQuantityPlots(conf, ["AK5PFJets", "AK5PFJetsCHS", "AK5PFJetsCHSL1", "AK5PFJetsL1L2L3", "AK5PFJetsCHSL1L2L3",
 "AK5PFJetsL1L2L3Res", "AK5PFJetsCHSL1L2L3Res"], forIncut=True, forAllevents=True, forIncutVariations=True, forAlleventsVariations=False)
