...
conf["InputFiles"] = cbase.CreateFileList("/storage/6/berger/zpj/kappa52_MC12_madgraph/*.root", sys.argv)
...
cbase.ApplyPUReweighting(conf, "kappa52_MC12_madgraph_190456-191859_8TeV_PromptReco")
