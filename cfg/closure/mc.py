...
def get_template(algo="AK5PFJets"):
    ...
    algorithms = [algo, algo+"L1", algo+"L1L2L3"]
    ...
    variations += [ cbase.ExpandRange2(conf["Pipelines"], "Flavour", [123, 4, 5, 21], onlyBasicQuantities=True, alsoForPtBins=False, onlyOnIncut=False, forAlleta=True) ]
