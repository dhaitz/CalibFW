...
conf['Jec'] = cbase.GetBasePath() + "data/jec_data/Fall12_V1_DATA"
conf["InputFiles"] = cbase.CreateFileList("/storage/6/berger/zpj/kappa53_Data12/*.root", sys.argv)
conf["OutputPath"] = "closure_data_2012_Fall12JEC"
...
variations = []
variations += [ cbase.ExpandRange(conf["Pipelines"], "CutSecondLeadingToZPt", [0.2, 0.3, 0.4], onlyBasicQuantities=False) ]
...
cbase.AddQuantityPlots(conf, ["AK5PFJetsCHS", "AK5PFJetsCHSL1", "AK5PFJetsL1L2L3", "AK5PFJetsCHSL1L2L3",
