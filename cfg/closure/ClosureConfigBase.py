...
def GetMcBaseConfig(analysis='zjet', run='2011'):
    ...
    if run == '2011':
        ...
        d["JecBase"] = GetBasePath() + "data/jec_data/Summer12_V7_MC"
    else:
...
def GetDataBaseConfig(analysis='zjet',run='2011'):
    ...
    if run == '2011':
        ...
        d["JecBase"] = GetBasePath() +  "data/jec_data/Summer12_V7_DATA"
        d["JsonFile"] = GetBasePath() + "data/json/Cert_190456-195396_8TeV_PromptReco_Collisions12_JSON_v2.txt"
    else:
