...
def get_template(algo="AK5PFJets"):
    ...
    conf["InputFiles"] = cbase.CreateFileList("/storage/6/berger/zpj/kappa539_MC12_herwig/*.root", sys.argv)
    conf['OutputPath'] = __file__.split('/')[-1][:-3]
    cbase.ApplyPUReweighting(conf, 'kappa539_MC12_herwig_190456-208686_8TeV_22Jan2013ReReco')
    cbase.ApplySampleReweighting(conf)
