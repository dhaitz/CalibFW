...
conf["InputFiles"] = cbase.ApplyFast( cbase.CreateFileList("/storage/6/berger/zpj/kappa44_Data11/kappa_2011A*.root"), sys.argv )
...
conf["OutputPath"] = "closure_data_2011A_only"
