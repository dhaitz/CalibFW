...
p.general.source_files=[ "/local/scratch/hauth/data/ZPJ2010/zplusjet_mc_fall10_weighted_gen.root", 
"/local/scratch/hauth/data/ZPJ2010/zplusjet_mc_fall10_gen.root"]
...
p.general.algos=["ak5Gen","ak5Gen"]#["ak5PF", "ak7PF", "kt4PF", "kt6PF", "iterativeCone5PF"]
p.general.good_algos=["MC Fall10 Z2 weighted", "MC Fall10 Z2 PtHat bins"]#["anti-kt 0.5 PF", "anti-kt 0.7 PF", "kt 0.4 PF", "kt 0.6 PF", "iterativeCone5 PF"]
...
p.general.info_string= multiline_text("p_{T}^{#mu}>15 GeV , |#eta^{#mu}|<2.3 , |M-M_{Z}|<20 GeV",
                                ...
                                "anti-kt 0.5 Gen jets",
                                "__CORR__")
p.general.correction_level = 0
p.general.lumi = 0
