...
public:
	...
	double getCorrectPt(const RMDataLV& lorentzVector, const int& chg) const;
	...
	double getSmearedPt(const RMDataLV& lorentzVector, const int& chg, bool fake = false) const;

	// Method to apply correction to a TLorentzVector
	void applyPtCorrection(RMDataLV& lorentzVector, const int& chg) const;

	// Method to apply smearing to a TLorentzVector
	void applyPtSmearing(RMDataLV& lorentzVector, const int& chg, bool fake = false) const;
