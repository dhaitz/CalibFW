...
ParSet::ParSet() {}
ParSet::ParSet(const TString& inputName, const double& inputStep, const double& inputMini, const double& inputMaxi) :
		step(inputStep),
		mini(inputMini),
		maxi(inputMaxi)
	{
...
template <class T>
void scaleFunctionBase<T>::setPar(double* Start, double* Step, double* Mini, double* Maxi, int* ind,
...
template <class T>
double scaleFunction50<T>::scale(const double& pt, const double& eta, const double& phi, const int chg, const T& parScale) const
	{
...
template <class T>
	double resolutionFunction57<T>::centralParabola(const double& pt, const double& eta, const T& parval)
	{
...
template <class T>
	inline double resolutionFunction57<T>::rightParabola(const double& pt, const double& eta, const T& parval)
	{
		return parval[8] + parval[9] * (eta - parval[3]) * (eta - parval[3]);
	}
template <class T>
	inline double resolutionFunction57<T>::leftLine(const double& pt, const double& eta, const T& parval)
	{
