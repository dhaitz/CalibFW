#ifndef __ZPLUSJETDRAW_H__
#define __ZPLUSJETDRAW_H__
...
typedef DrawGraphErrorsConsumerBase<EventResult, ZJetPipelineSettings> ZJetGraphErrors;
...
{
public:
	DrawJetConsumerBase( int jetNum ) : DrawHist1dConsumerBase<EventResult, ZJetPipelineSettings>(),
		m_jetNum ( jetNum )
	{
	}
...
{
public:
	DrawDeltaPhiRange( ) : 	ZJetGraphErrors()
	{
	}
	virtual void Finish()
	{
...
{
public:
	DrawJetGraphBase( int jetNum) : ZJetGraphErrors(), m_jetNum (jetNum)
		{
...
{
public:
	DrawCutIneffGraph( int cutId ) : ZJetGraphErrors(),
		m_iCutId( cutId)
	{
