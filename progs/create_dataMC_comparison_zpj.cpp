...
//         return ret_val;
    ...
    void setMinimum(double min){m_minimum=min;};
...
//     repsponse_data.Draw("P");
    ...
    gMinuit->SetPrintLevel(1); Double_t p=100;Int_t one=1;gMinuit->mnexcm("MIGRAD",&p,one,one);gMinuit->mnmnos();
    ...
    gStyle->SetPalette(1);
    TCanvas c("mycan","mycan",800,600);c.cd();
...
//     contours[0]=contours[1];
    ...
    centre.SetMarkerStyle(20);centre.SetMarkerSize(5);
    ...
    contours[0].SetLineColor(kRed);contours[0].SetLineStyle(2);
    contours[1].SetLineColor(kBlue);contours[1].SetLineStyle(2);
