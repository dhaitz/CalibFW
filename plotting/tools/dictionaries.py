...
d_axes = {
        'abseta': [0.0, 5.5, r"$|\eta^\text{%s}|$", ""],
        'absphi': [0, 3.141593, r"$|\phi^\text{%s}|$", ""],
        'alpha': [0, 0.5, r"$p_\text{T}^\text{Jet 2}/p_\text{T}^\text{Z}$", ""],
        'bal': [0.0, 1.8, r"$p_\text{T}$ balance", ""],
        'balparton': [0.0, 1.8, r"Matching parton $p_\text{T}$ / GenZ $p_\text{T}$ ", ""],
        'balrespjet2': [0, 1, r"$p_\text{T}^\text{Jet 2}/p_\text{T}^{Z}$", ""],
        'balresp': [0.0, 1.8, r"$p_\text{T}$ balance", ""],
        'balresp_ratio': [0.9, 1.1, r"$p_\text{T}$ balance", ""],
        'baltwojet': [0.0, 1.8, r"$p_\text{T}$ balance for 2 jets", ""],
        ...
        'deltaeta': [0, 15, r"$\Delta \eta(\text{%s})$", ""],
        'deltaeta': [0, 5, r"$\Delta \eta(\text{%s,\/ %s})$", ""],
        'deltaphi': [0, 3.141593, r"$\Delta \phi(\text{%s,\/%s})$", ""],
        'deltar': [0, 20, r"$\Delta \/R(\text{%s,\/ %s})$", ""],
        'eemass': [0, 120, r"$m_{e^{-}e^{+}}$", "GeV"],
        'electron': [0, 1, r"%s electron fraction", ""],
        'epluspt': [0, 150, r"$p_\text{T}^\text{e^{+}}$", 'GeV'],
        'eminuspt': [0, 150, r"$p_\text{T}^\text{e^{-}}$", 'GeV'],
        'eta': [-5, 5, r"$\eta^\text{%s}$", ""],
        ...
        'genalpha': [0, 0.4, r"$p_\text{T}^\text{GenJet 2}/p_\text{T}^\text{GenZ}$", ""],
        'genbal-tobalparton': [0.501, 1.501, r"Parton Response $p_\text{T}^\text{GenJet}/p_\text{T}^\text{Parton}$", ""],
        'genbal-toparton': [0.501, 1.501, r"Parton Response $p_\text{T}^\text{GenJet}/p_\text{T}^\text{Parton_1}$", ""],
        'genbalance': [0.7, 1.1, r"$p_\text{T}$ balance (Gen Jet / Reco Z)", ""],
        'genbal': [0.501, 1.501, r"$p_\text{T}$ balance (Gen Jet / Gen Z)", ""],
        'genjet1pt': [0, 250, r"$p_\text{T}^\text{Leading Gen Jet}$", 'GeV'],
        'genjet2pt': [0, 100, r"$p_\text{T}^\text{GenJet2}$", 'GeV'],
        'genmpf': [0.501, 1.501, r"Gen MPF Response", ""],
        'genpt': [0, 250, r"$p_\text{T}^\text{Gen Jet}$", 'GeV'],
        'genzep': [0.0, 3.0, r"Zeppenfeld variable (Gen level)", ""],
        'genzetarapidityratio': [-4, 4, r"$\eta^\text{GenZ} / y^\text{GenZ}$", ""],
        'genzmass': [70, 110, r"$m^\text{GenZ}$", "GeV"],
        'genzrapidity': [-4, 4, r"$y^\text{GenZ}$", ""],
        'genzpt': [0, 250, r"$p_\text{T}^\text{GenZ}$", 'GeV'],
        ...
        'jet1pt': [0, 250, r"$p_\text{T}^\text{Leading Jet}$", 'GeV'],
        'jet2area': [0.6, 1, r"Second Jet area", ""],
        'jet2pt': [0, 100, r"$p_\text{T}^\text{Jet2}$", 'GeV'],
        'jet2ratio': [0, 0.4, r"$p_\text{T}^\text{Jet_2}/p_\text{T}^{Z}$", ""],
        'jet3pt': [0, 100, r"$p_\text{T}^\text{Jet3}$", 'GeV'],
        'jetpt': [0, 250, r"$p_\text{T}^\text{Z}$", 'GeV'],
        'jetptabsdiff': [0, 100, r"$p_\text{T}^\text{Jet 1} - p_\text{T}^{Jet 2}$", "GeV"],
        'jetptratio': [0, 10, r"$p_\text{T}^\text{Jet 1} / p_\text{T}^{Jet 2}$", ""],
        ...
        'matchedgenjet1pt': [0, 250, r"$p_\text{T}^\text{Matched Leading Gen Jet}$", 'GeV'],
        'METeta': [-0.1, 0.1, r"$\eta^\text{MET}$", ""],
        'METfraction': [0, 0.2, r"MET / $E^T_Total$", ""],
        'METpt': [0, 80, r"$E_\text{T}^\text{miss}$", 'GeV'],
        'METpt-diff': [0, 10, r"$\Delta E_\text{T}^\text{miss}$ (TypeI-corrected - raw)", 'GeV'],
        'METsumEt': [0, 2500, r"$\sum E^\text{T}$", "GeV"],
        ...
        'muminuspt': [0, 250, r"$p_\text{T}^\text{\mu-}$", 'GeV'],
        'mu1pt': [0, 250, r"$p_\text{T}^\text{\mu1}$", 'GeV'],
        'mu2pt': [0, 250, r"$p_\text{T}^\text{\mu2}$", 'GeV'],
        'muon': [0, 1, r"%s muon fraction", ""],
        'muonsinvalid': [0, 5, "Number of invalid muons", ""],
        'muonsvalid': [0, 5, "Number of valid muons", ""],
        'mupluspt': [0, 250, r"$p_\text{T}^\text{\mu+}$", 'GeV'],
        'muresp': [0.501, 1.501, r"Muon Response $p_\text{T}^\text{\mu,reco}/p_\text{T}^\text{\mu,gen}$", ""],
        'neutralem': [0, 1, r"%s neutral em fraction", ""],
        'neutralhad': [0, 1., r"%s neutral hadron fraction", ""],
        'npv': [-0.5, 35.5, r"Number of Reconstructed Vertices $n$", ""],
        'numpu': [0, 35, r"Number of Primary Vertices", ""],
        'numputruth': [0, 35, r"Pile-up Truth (Poisson mean)", ""],
        'parton': [0.0, 1.8, r"Leading parton$p_\text{T}$ / $p_\text{T}^\text{GenZ}$ ", ""],
        'phi': [-3.141592653, 3.141592653, r"$\phi^\text{%s}$", ""],
        'photon': [0, 1., r"%s photon fraction", ""],
        'photonresponse': [0, 1., r"%s photon fraction * response", ""],
        'pt': [0, 250, r"$p_\text{T}$", 'GeV'],
        'ptbalance': [0., 2., r"$p_\text{T}$ balance", ""],
        'ratio': [0.95, 1.05, r"%s / %s ratio", ""],
        'rawMETpt': [0, 80, r"$E_\text{T}^\text{miss}$ (RAW)", 'GeV'],
        'reco': [0, 35, r"Number of Reconstructed Vertices $n$", ""],
        'recogen': [0.501, 1.501, r"Jet Response $p_\text{T}^\text{RecoJet}/p_\text{T}^\text{GenJet}$", ""],
        ...
        'subleadingjetspt': [0, 1000, r"$p_\text{T}^\text{Subleading Jets}$", 'GeV'],
        'sumEt': [0, 2500, r"$\sum E^\text{T}$", "GeV"],
        'summedf': [0.8, 1.2, r"$%s$ fraction sum", ""],
        'summedfr': [0.8, 1.2, r"$%s$ fraction sum2", ""],
        'tagflavour': [-0.5, 24.5, r"Flavour (from tagging)", ""],
        'uept': [0, 250, r"$p_\text{T}^\text{Unclustered Energy}$", 'GeV'],
        'unc': [0, 0.25, r"Leading jet uncertainty", ''],
        'xsec': [0, 20, r"$n_\text{Events} / \mathcal{L}$", "pb$^{-1}$"],
        'zeppenfeld': [0.0, 3, r"Zeppenfeld variable", ""],
        'zmass': [70, 110, r"$m^\text{Z}$", "GeV"],
        'zones': [-0.5, 24.5, r"Tagging zone", ""],
        'zpt': [0, 1000, r"$p_\text{T}^\text{Z}$", 'GeV'],
        'oldbalresp': [0.0, 1.8, r"$p_\text{T}$ balance (old version)", ""],
