...
d_axes = {
        ...
        'components-response-diff': [-0.1, 0.1, r"jet fraction $\cdot$ response", ""],
        'components-diff-response': [-0.1, 0.1, r"Leading Jet Component Fraction $\cdot$ Response", ""],
        'components': [0, 1, r"Leading jet fraction", ""],
